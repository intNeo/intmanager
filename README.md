...
- Собираем образ: `docker build -t intneo/dsbotintmanager:1.1.0 .`

##### Шаги:
- После успешной сборки создаем: `config/.env` и пишем свой `DISCORD_TOKEN=`
